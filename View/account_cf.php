                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-sm-9">
                                <div class="text-muted mb-0 text-dark fz-1 border-0" name="username"><?=$username?>
                                </div>
                            </div>
                        </div>
                        <hr>
                        <div class="row  d-flex align-items-center">
                            ...
                            <div class="col-sm-9 text-dark fz-1">
                                ...
                                <div class="text-muted mb-0 text-dark fz-1 border-0" name="email"><?=$email?>
                                </div>
                            </div>
                        </div>
                        <hr>
                        <div class="row  d-flex align-items-center">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="text-muted mb-0 text-dark fz-1 border-0" name="sdt"><?=$sdt?>
                                </div>
                            </div>
                        </div>
                        <hr>
                        <div class="row  d-flex align-items-center pb-3 ">
                            ...
                            <div class="col-sm-9">
                                <div class="text-muted mb-0 text-dark fz-1 border-0" name="dia_chi"><?=$dia_chi?>
                                </div>
                            </div>
                        </div>
                        <a href="index.php?pg=account"><button class="btn button-app">Cập nhật thông
                                tin</button></a>
                    </div>
                </div>
                <div class="row">
