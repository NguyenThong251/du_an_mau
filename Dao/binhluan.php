...
function binhluan_insert($id_user, $noi_dung, $ngay_cmt, $ho_ten, $id_sp){
    $sql = "INSERT INTO binh_luan (id_user, noi_dung, ngay_cmt, ho_ten, id_sp) VALUES (?, ?, ?, ?, ?)";
     pdo_execute($sql, $id_user, $noi_dung, $ngay_cmt, $ho_ten, $id_sp);
}
...
function binhluan_select_all(){
    $sql = "SELECT * FROM binh_luan ORDER BY id_cmt DESC";
